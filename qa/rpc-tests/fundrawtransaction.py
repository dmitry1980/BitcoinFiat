...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid bitcoinfiat address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid bitcoinfiat address" in e.error['message'])
        ...
        # send 12 BITCOINFIAT to msig addr
