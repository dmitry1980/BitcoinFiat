...
official/supported Docker Images found at https://hub.docker.com/r/dmitry1980/bitcoinfiatd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/dmitry1980/bitcoinfiatd-develop/ when changing the above text**