...
void BitcoinGUI::createActions()
{
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Bitcoinfiat command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::message(const QString &title, const QString &message, unsigned int style, bool *ret)
{
    ...
    // Append title to "Bitcoinfiat Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
