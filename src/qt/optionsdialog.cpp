    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BITCOINFIAT-light"), QVariant("light"));
    ui->theme->addItem(QString("BITCOINFIAT-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("BITCOINFIAT-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("BITCOINFIAT-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("BITCOINFIAT-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BITCOINFIAT-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BITCOINFIAT-traditional"), QVariant("trad"));
