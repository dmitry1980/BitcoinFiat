...
All the Bitcoinfiat in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BITCOINFIAT, 0.1 BITCOINFIAT, 1 BITCOINFIAT and 10 BITCOINFIAT -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://dmitry1980.atlassian.net/wiki/display/DOC/PrivateSend\">https://dmitry1980.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
