...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Bitcoinfiat address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "bitcoinfiat",               "masternode",             &masternode,             true,  {} },
    { "bitcoinfiat",               "masternodelist",         &masternodelist,         true,  {} },
    { "bitcoinfiat",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "bitcoinfiat",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "bitcoinfiat",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "bitcoinfiat",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
