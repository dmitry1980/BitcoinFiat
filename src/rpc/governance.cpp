...
//#define ENABLE_BITCOINFIAT_DEBUG
...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in bitcoinfiat.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("bitcoinfiat.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    ...
    { "bitcoinfiat",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "bitcoinfiat",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "bitcoinfiat",               "gobject",                &gobject,                true,  {} },
    { "bitcoinfiat",               "voteraw",                &voteraw,                true,  {} },
