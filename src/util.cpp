...
const char * const BITCOIN_CONF_FILENAME = "bitcoinfiat.conf";
const char * const BITCOIN_PID_FILENAME = "bitcoinfiatd.pid";
    ...
    if (category != NULL)
    {
        ...
        if (ptrCategory.get() == NULL)
        {
            if (mapMultiArgs.count("-debug")) {
                ...
                if(ptrCategory->count(std::string("bitcoinfiat"))) {
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\BitcoinfiatCore
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\BitcoinfiatCore
    // Mac: ~/Library/Application Support/BitcoinfiatCore
    // Unix: ~/.bitcoinfiatcore
#ifdef WIN32
    // Windows
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/BitcoinfiatCore";
#else
    // Unix
...
void ReadConfigFile(const std::string& confPath)
{
    ...
    if (!streamConfig.good()){
        // Create empty bitcoinfiat.conf if it does not excist
